            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="4">
                                <button type="button" class="btn btn-custom mb-2" style="background-color:#0A5C36;" id="tambahKolomExwork">Tambah Komponen Baru</button>
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="4">
                                <button type="button" class="btn btn-custom mb-2" style="background-color:#0A5C36;" id="tambahKolomFOB">Tambah Komponen Baru</button>
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="4">
                                <button type="button" class="btn btn-custom mb-2" style="background-color:#0A5C36;" id="tambahKolomCFR">Tambah Komponen Baru</button>
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="4">
                                <button type="button" class="btn btn-custom mb-2" style="background-color:#0A5C36;" id="tambahKolomCIF">Tambah Komponen Baru</button>
