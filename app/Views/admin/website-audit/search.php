...
<div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">
        <div class="row g-3 mb-4 align-items-center justify-content-between">
            <div class="col-auto">
                <h1 class="app-page-title mb-0" style="color: #0A5C36;">List Website Audit</h1>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center align-middle">
                                            <div class="d-flex justify-content-center align-items-center">
                                                <?php if ($item['status_verifikasi'] === 'waiting'): ?>
                                                    <a href="<?= base_url('admin-process-website-audit/' . $item['id_webaudit']) ?>" class="btn btn-sm text-white" style="background-color: #0A5C36;">Audit</a>
                                                <?php else: ?>
                                                    <!-- Nothing -->
                                                <?php endif; ?>
                                            </div>
