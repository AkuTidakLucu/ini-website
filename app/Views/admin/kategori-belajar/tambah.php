...
<div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">
        <h1 class="app-page-title" style="color: #0A5C36;">Tambah Kategori Belajar Ekspor</h1>
        <hr class="mb-4">
                ...
                <div class="app-card app-card-settings shadow-sm p-4">
                    <div class="card-body">
                        <form action="<?= base_url('/admin-kategori-belajar-ekspor-create') ?>" method="POST">
                            ...
                            <div class="mb-3">
                                <button type="submit" class="btn text-white" style="background-color: #0A5C36;">Simpan</button>
