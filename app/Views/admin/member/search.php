...
<div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">
        <div class="row g-3 mb-4 align-items-center justify-content-between">
            <div class="col-auto">
                <h1 class="app-page-title mb-0" style="color: #0A5C36;">List Member</h1>
            </div>
            ...
            <div class="col-auto">
                <a href="<?= base_url('admin-add-member') ?>" class="btn text-white" style="background-color: #0A5C36;">
                                        ...
                                        <td class="text-center align-middle">
                                            <div class="d-flex justify-content-center align-items-center">
                                                <a href="<?= base_url('admin-delete-member/' . $item['id_member']) ?>"
                                                    ...
                                                    style="background-color: #D4AF37;">Hapus</a>
                                                <a href="<?= base_url('admin-edit-member/' . $item['id_member']) ?>"
                                                    class="btn btn-sm text-white"
                                                    style="background-color: #0A5C36;">Ubah</a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
