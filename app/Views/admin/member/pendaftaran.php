...
<div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">
        <div class="row g-3 mb-4 align-items-center justify-content-between">
            <div class="col-auto">
                <h1 class="app-page-title mb-0" style="color: #0A5C36;">List Calon Member</h1>
            </div>
        </div>
                                            ...
                                            <div class="modal fade" id="konfirmasiModal<?= $item['id_member'] ?>" tabindex="-1" aria-labelledby="konfirmasiLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content" style="border-radius:10px;">
                                                        <div class="modal-header" style="background-color:#0A5C36; color:white;">
                                                        ...
                                                        <div class="modal-footer d-flex justify-content-center">
                                                            ...
                                                            <a href="<?= base_url('admin-konfirmasi-member/' . $item['id_member']) ?>" class="btn text-white" style="background-color:#0A5C36;">Ya, Konfirmasi</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
