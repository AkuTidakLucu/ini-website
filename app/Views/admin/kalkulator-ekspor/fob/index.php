...
<div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">
        <div class="row g-3 mb-4 align-items-center justify-content-between">
            <div class="col-auto">
                <h1 class="app-page-title mb-0" style="color: #0A5C36;">List FOB</h1>
            </div>
            ...
            <div class="col-auto">
                <a href="<?= base_url('admin-add-fob') ?>" class="btn text-white" style="background-color: #0A5C36;"> + Tambah Data FOB</a>
            </div>
        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center align-middle">
                                            <div class="d-flex justify-content-center align-items-center">
                                                <a href="<?= base_url('admin-delete-fob/' . $item['id_fob']) ?>" class="btn btn-sm text-white me-2" style="background-color: #D4AF37;">
                                                    Hapus
                                                </a>
                                                <a href="<?= base_url('admin-edit-fob/' . $item['id_fob']) ?>" class="btn btn-sm text-white" style="background-color: #0A5C36;">
                                                    Ubah
                                                </a>
                                            </div>
                                        </td>
