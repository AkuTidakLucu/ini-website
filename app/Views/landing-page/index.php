...
<style>
        ...
        .certificate-card:hover {
            ...
            box-shadow: 0 10px 20px rgba(111, 78, 55, 0.2); /* Coffee Bean shadow */
        }
        ...
        .image-logo {
            width: 100%;
            height: 100%;
            box-shadow: 0 4px 8px rgba(111, 78, 55, 0.1); /* Coffee Bean shadow */
            border-radius: 10px;
            border: 1px solid rgba(111, 78, 55, 0.1); /* Coffee Bean border */
        }
        ...
        .loader-container {
            ...
            justify-content: center;
            align-items: center;
            background-color: rgba(254, 216, 177, 0.8); /* Soft Apricot dengan opacity */
        ...
        .loader {
            ...
            border-radius: 50%;
            border-right-color: var(--c-primary); /* Coffee Bean */
        ...
        .navbar {
            ...
            padding: 10px 75px;
            box-shadow: 0 4px 6px rgba(111, 78, 55, 0.1); /* Coffee Bean shadow */
        }
        ...
        .kontak-kami h1 {
            font-size: 32px;
            margin-bottom: 60px;
            background: linear-gradient(to right, var(--c-primary), var(--c-accent-light)); /* Coffee Bean ke Light Caramel */
        ...
        .form-group {
            ...
            border: 1px solid rgba(111, 78, 55, 0.1); /* Coffee Bean border */
            border-radius: 10px;
            box-shadow: 0 0 10px rgba(111, 78, 55, 0.1); /* Coffee Bean shadow */
            margin-bottom: 20px;
        }
        ...
        .form-control {
            ...
            padding: 10px;
            margin-bottom: 10px;
            border: 1px solid rgba(111, 78, 55, 0.2); /* Coffee Bean border */
            border-radius: 5px;
            text-align: center;
            background-color: var(--c-white); /* Pure White */
            color: var(--c-text); /* Deep Cocoa */
        ...
        .form-control:focus {
            border-color: var(--c-accent-light); /* Light Caramel */
            box-shadow: 0 0 10px rgba(236, 177, 118, 0.2); /* Light Caramel shadow */
        }
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" style="color: #0A5C36;" href="#beranda">Beranda</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="static-image">
        <img src="<?= base_url(relativePath: 'img/slider-1.jpg') ?>" class="d-block w-100" style="height: 650px;" alt="Slide" loading="lazy">
    </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-5 text-center mb-4 mb-md-0">
                    <div class="logo-sonic">
                        <img src="<?= base_url(relativePath: 'img/p21.jpg') ?>" alt="Logo SonicPulse" class="image-logo img-fluid" loading="lazy">
                    </div>
                </div>
    ...
    <div id="data-produk" class="container produk-kami">
        ...
        <div class="cards-container">
            ...
            <a class="row justify-content-center gap-5" href="#" style="text-decoration: none; color: #0A5C36;">
                <div class="card">
