    ...
    <div class="row mt-5">
            ...
            <div class="col-md-4 mb-4 animate__animated animate__zoomIn">
                <div class="card h-100 shadow-sm">
                    ...
                    <div class="card-footer text-center">
                        <a href="<?= base_url('/detail-pengumuman-premium/' . $item['slug']); ?>" class="btn btn-custom" style="background-color: #0A5C36;">Baca
                            Selengkapnya</a>
                    </div>
                </div>
            </div>
        ...
        <!-- <div class="col-md-4 mb-4 animate__animated animate__zoomIn animate__delay-1s">
            <div class="card h-100 shadow-sm">
                ...
                <div class="card-footer text-center">
                    <a href="detail-pengumuman" class="btn btn-custom" style="background-color: #0A5C36;">Baca
                        Selengkapnya</a>
                </div>
            </div>
        </div> -->
