...
<body>
    <!-- header -->
    <header class="header section--topbar">
        <div class="container">
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-light">
                                    ...
                                    <li>
                                        <a class="dropdown-item nav-link"
                                            href="<?= base_url(relativePath: 'premium-video-tutorial') ?>">
                                            Video Tutorial
                                        </a>
                                    </li>
                                </ul>
                        ...
                        <div class="dropdown">
                            ...
                            <?php if (session()->get('role') == 'admin'): ?>
                                <ul class="dropdown-menu" aria-labelledby="userDropdown">
                                    <li><a class="dropdown-item" href="<?= base_url('/admin-dashboard') ?>"><i class="bi bi-box-arrow-in-left" style="color: var(--c-primary); font-size: 20px;"></i> Tampilan Admin</a></li>
    ...
    <!-- start footer -->
    <footer class="mt-5 section--footer" style="color: #fff;">
