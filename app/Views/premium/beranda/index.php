...
<style>
    /* Color Palette: The Professional Global (Emerald & Gold) */
    :root {
    ...
    .card-container::before {
        ...
        position: absolute;
        inset: 0;
        background: linear-gradient(-25deg, var(--c-primary) 0%, var(--c-primary) 100%);
    ...
    .card .img-content {
        ...
        background: linear-gradient(-25deg, white 0%, var(--c-primary) 100%);
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item" data-bs-interval="2000">
                ...
                <div class="carousel-caption d-block text-light mb-3">
                    ...
                    <p><?= esc(strip_tags(($lang == 'en') ? $slider[1]['deskripsi_slider_en'] : $slider[1]['deskripsi_slider'])) ?></p>
                </div>
            </div>
            <!-- Slide 3 -->
            <div class="carousel-item">
                ...
                <div class="carousel-caption d-block text-light mb-3">
                    ...
                    <p><?= esc(strip_tags(($lang == 'en') ? $slider[2]['deskripsi_slider_en'] : $slider[2]['deskripsi_slider'])) ?></p>
                </div>
            </div>
        </div>
    ...
    <div class="member container mt-5">
        <div class="d-flex justify-content-center">
            <div class="garis d-flex justify-content-center align-items-center mb-2">
                <div class="border-top1 mx-2" style="width: 40px; height: 2px; background-color: #0A5C36;"></div>
            </div>
            <h5 class="fw-lighter" data-en="ABOUT US" data-id="TENTANG KAMI"><?= lang('Blog.populerMemberTitle'); ?></h5>
            <div class="garis d-flex justify-content-center align-items-center mb-2">
            <div class="border-top1 ms-2" style="width: 40px; height: 2px; background-color: var(--c-primary);"></div>
            </div>
        </div>
        <h1 class="text-center" data-en="WHO WE ARE" data-id="SIAPA KAMI"><b><?= lang('Blog.topMemberSpotlightTitle'); ?><span style="color: var(--c-primary);"> SPOTLIGHT</span></b></h1>
    </div>
                ...
                <?php foreach ($top4_member as $item): ?>
                    <div class="col-12 col-md-6 col-lg-3 rounded"> <!-- Responsive column sizes -->
                        <div class="card">
                            ...
                            <div class="content text-center" style="padding: 10px 0; color: var(--c-primary);">
...
<!-- tombol daftar -->
<section class="container-fluid text-dark rounded-5 daftar-section" style="background-color: var(--c-primary); max-width: 1100px; margin-top: 80px; padding: 40px;">
...
<section>
    <div class="benefit container text-center py-5 mt-2">
        <h2 class="fw-bold mb-3" style="color: var(--c-primary);"><?= lang('Blog.benefitsJoinTitle'); ?></h2>
        <div class="d-flex justify-content-center align-items-center mb-2">
            <div class="border-top5" style="width: 60px; height: 3px; background-color: var(--c-primary);"></div>
        </div>
        <div class="d-flex justify-content-center align-items-center">
            <div class="border-top6" style="width: 30px; height: 2px; background-color: var(--c-primary);"></div>
        </div>
...
<!-- ajakan -->
<section class="animasi mt-5 footer-custom" style="background-color: #0A5C36; width: 100%; height: 350px;">
...
<section class="container mt-5">
        <div class="kata1 text-center">
            <div class="d-flex justify-content-center">
                <div class="d-flex justify-content-center align-items-center mb-2">
                    <div class="border-top6 mx-2" style="width: 40px; height: 2px; background-color: var(--c-primary);"></div>
                </div>
                <h5 class="fw-lighter">YOUR PACKAGE</h5>
            <div class="d-flex justify-content-center align-items-center mb-2">
                <div class="border-top7 ms-2" style="width: 40px; height: 2px; background-color: var(--c-primary);"></div>
            </div>
        </div>
        <h1 class="fw-bold text-dark"><span style="color: var(--c-primary);">CHOOSE THE RIGHT PACKAGE</span> FOR YOU</h1>
    </div>
...
<section class="container peta2">
    <div class="peta mt-5">
        ...
        <h1 class="text-center" data-en="TOP MEMBERS SPOTLIGHT" data-id="SOROTAN MEMBER UNGGUL"><b><?= lang('Blog.communityMemberSpotlightTitle'); ?><span style="color: var(--c-primary);"> <?= lang('Blog.communityMemberSpotlightTitle2'); ?></span></b></h1>
    </div>
